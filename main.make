Main.cc : Main.o Lancamento.o ListaContabil.o
	g++ -o Main.cc Main.o ListaContabil.o Lancamento.o
...
Main.o: Main.cpp ListaContabil.h Lancamento.h
	g++ -c Main.cpp
...
Stack.o : Stack.h ListaContabil.cpp Lancamento.cpp
	g++ -c Stack.cpp
